...
export function displayMeritosDefectos() {
  const meritosDefectosDiv = document.querySelector(".meritosDefectos-list");
  backgroundsDiv.innerHTML = "";
  const addMeritosDefectosContainer = document.querySelector(
    ".agregar-meritosDefectos-container"
  );
  addMeritosDefectosContainer.innerHTML = "";

  createMeritosDefectosList(meritosDefectosDiv);

  addMeritosDefectosContainer.appendChild(addMeritosDefectosButton());
}

function createMeritosDefectosList(meritosDefectosListContainer) {
  meritosDefectosListContainer.innerHTML = "";

  const activeMeritosDefectos = meritosDefectos.filter(
    (meritosDefectos) => meritosDefectos.active
  );
